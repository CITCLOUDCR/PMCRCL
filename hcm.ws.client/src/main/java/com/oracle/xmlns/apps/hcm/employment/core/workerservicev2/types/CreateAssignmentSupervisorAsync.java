...
import com.oracle.xmlns.apps.hcm.employment.core.workerservicev2.AssignmentSupervisor;
 ...
 *       &lt;sequence>
 *         &lt;element name="AL" type="{http://xmlns.oracle.com/apps/hcm/employment/core/workerServiceV2/}AssignmentSupervisor"/>
...
@XmlRootElement(name = "createAssignmentSupervisorAsync")
public class CreateAssignmentSupervisorAsync {

    @XmlElement(name = "AL", required = true)
    protected AssignmentSupervisor al;
     ...
     *     
     */
    public AssignmentSupervisor getAL() {
        return al;
    }
     ...
     *     
     */
    public void setAL(AssignmentSupervisor value) {
        this.al = value;
    }
