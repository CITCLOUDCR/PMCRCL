...
/**
 * <p>Java class for PersonContactRelLegDDF complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PersonContactRelLegDDF">
 *   &lt;complexContent>
...
@XmlType(name = "PersonContactRelLegDDF", propOrder = {
...
@XmlSeeAlso({
    PersonContactRelLegDDFORA5FHRX5FBE.class,
    PersonContactRelLegDDFSA.class,
    UnitedStatesOfAmericaContactIn.class,
    PersonContactRelLegDDFCH.class,
    PersonContactRelLegDDFAE.class,
    PersonContactRelLegDDFKW.class,
    PersonContactRelLegDDFAU.class,
    PersonContactRelLegDDFIN.class
})
public class PersonContactRelLegDDF {
    ...
    @XmlElementRef(name = "__FLEX_Context", namespace = "http://xmlns.oracle.com/apps/hcm/people/core/flex/personContactRelLegDDF/", type = JAXBElement.class)
    protected JAXBElement<String> flexContext;
    @XmlElementRef(name = "__FLEX_Context_DisplayValue", namespace = "http://xmlns.oracle.com/apps/hcm/people/core/flex/personContactRelLegDDF/", type = JAXBElement.class)
    protected JAXBElement<String> flexContextDisplayValue;
    @XmlElementRef(name = "_FLEX_NumOfSegments", namespace = "http://xmlns.oracle.com/apps/hcm/people/core/flex/personContactRelLegDDF/", type = JAXBElement.class)
