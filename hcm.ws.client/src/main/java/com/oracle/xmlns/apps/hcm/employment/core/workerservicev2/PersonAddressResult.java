 ...
 *       &lt;sequence>
 *         &lt;element name="Value" type="{http://xmlns.oracle.com/apps/hcm/employment/core/workerServiceV2/}PersonAddress" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends MethodResult
{
    ...
    protected List<PersonAddress> value;
     ...
     * 
     */
    public List<PersonAddress> getValue() {
        if (value == null) {
            value = new ArrayList<PersonAddress>();
        }
        return this.value;
    }
