...
/**
 * <p>Java class for ContractLegDDF complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ContractLegDDF">
 *   &lt;complexContent>
...
@XmlType(name = "ContractLegDDF", propOrder = {
    "contractId",
    "effectiveStartDate",
    "effectiveEndDate",
    "flexContext",
...
@XmlSeeAlso({
    ContractLegDDFKW.class,
    ContractLegDDFCN.class,
    ContractLegDDFFR.class,
    ContractLegDDFAE.class,
    ContractLegDDFSA.class,
    ContractLegDDFORA5FHRX5FBE.class,
    ContractLegDDFCH.class
})
public class ContractLegDDF {
    ...
    @XmlElementRef(name = "__FLEX_Context", namespace = "http://xmlns.oracle.com/apps/hcm/employment/core/flex/contractDDF/", type = JAXBElement.class)
    protected JAXBElement<String> flexContext;
    @XmlElementRef(name = "__FLEX_Context_DisplayValue", namespace = "http://xmlns.oracle.com/apps/hcm/employment/core/flex/contractDDF/", type = JAXBElement.class)
    protected JAXBElement<String> flexContextDisplayValue;
    @XmlElementRef(name = "_FLEX_NumOfSegments", namespace = "http://xmlns.oracle.com/apps/hcm/employment/core/flex/contractDDF/", type = JAXBElement.class)
