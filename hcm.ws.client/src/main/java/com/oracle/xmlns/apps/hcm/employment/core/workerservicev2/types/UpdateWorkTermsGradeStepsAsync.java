...
import com.oracle.xmlns.apps.hcm.employment.core.workerservicev2.WorkTermsGradeSteps;
 ...
 *       &lt;sequence>
 *         &lt;element name="AL" type="{http://xmlns.oracle.com/apps/hcm/employment/core/workerServiceV2/}WorkTermsGradeSteps"/>
...
@XmlRootElement(name = "updateWorkTermsGradeStepsAsync")
public class UpdateWorkTermsGradeStepsAsync {

    @XmlElement(name = "AL", required = true)
    protected WorkTermsGradeSteps al;
     ...
     *     
     */
    public WorkTermsGradeSteps getAL() {
        return al;
    }
     ...
     *     
     */
    public void setAL(WorkTermsGradeSteps value) {
        this.al = value;
    }
