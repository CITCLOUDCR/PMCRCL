...
/**
 * <p>Java class for DeliveryMethodDFF complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="DeliveryMethodDFF">
 *   &lt;complexContent>
...
@XmlType(name = "DeliveryMethodDFF", propOrder = {
    "deliveryMethodId",
    "flexContext",
    "flexContextDisplayValue",
    "flexNumOfSegments"
})
public class DeliveryMethodDFF {

    @XmlElement(name = "DeliveryMethodId")
    protected Long deliveryMethodId;
    @XmlElementRef(name = "__FLEX_Context", namespace = "http://xmlns.oracle.com/apps/hcm/people/core/flex/deliveryMethodDFF/", type = JAXBElement.class)
    protected JAXBElement<String> flexContext;
    @XmlElementRef(name = "__FLEX_Context_DisplayValue", namespace = "http://xmlns.oracle.com/apps/hcm/people/core/flex/deliveryMethodDFF/", type = JAXBElement.class)
    protected JAXBElement<String> flexContextDisplayValue;
    @XmlElementRef(name = "_FLEX_NumOfSegments", namespace = "http://xmlns.oracle.com/apps/hcm/people/core/flex/deliveryMethodDFF/", type = JAXBElement.class)
