...
/**
 * <p>Java class for AssignGradeStepsLegDDF complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AssignGradeStepsLegDDF">
 *   &lt;complexContent>
...
@XmlType(name = "AssignGradeStepsLegDDF", propOrder = {
    "assignGradeStepId",
    "effectiveStartDate",
    "effectiveEndDate",
    "flexContext",
...
public class AssignGradeStepsLegDDF {
    ...
    @XmlElementRef(name = "__FLEX_Context", namespace = "http://xmlns.oracle.com/apps/hcm/employment/core/flex/assignGradeStepsDDF/", type = JAXBElement.class)
    protected JAXBElement<String> flexContext;
    @XmlElementRef(name = "__FLEX_Context_DisplayValue", namespace = "http://xmlns.oracle.com/apps/hcm/employment/core/flex/assignGradeStepsDDF/", type = JAXBElement.class)
    protected JAXBElement<String> flexContextDisplayValue;
    @XmlElementRef(name = "_FLEX_NumOfSegments", namespace = "http://xmlns.oracle.com/apps/hcm/employment/core/flex/assignGradeStepsDDF/", type = JAXBElement.class)
