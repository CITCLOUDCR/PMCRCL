...
/**
 * <p>Java class for AsgSupervisorDFF complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AsgSupervisorDFF">
 *   &lt;complexContent>
...
@XmlType(name = "AsgSupervisorDFF", propOrder = {
...
public class AsgSupervisorDFF {
    ...
    @XmlElementRef(name = "__FLEX_Context", namespace = "http://xmlns.oracle.com/apps/hcm/employment/core/flex/assignmentSupervisorDFF/", type = JAXBElement.class)
    protected JAXBElement<String> flexContext;
    @XmlElementRef(name = "__FLEX_Context_DisplayValue", namespace = "http://xmlns.oracle.com/apps/hcm/employment/core/flex/assignmentSupervisorDFF/", type = JAXBElement.class)
    protected JAXBElement<String> flexContextDisplayValue;
    @XmlElementRef(name = "_FLEX_NumOfSegments", namespace = "http://xmlns.oracle.com/apps/hcm/employment/core/flex/assignmentSupervisorDFF/", type = JAXBElement.class)
