...
/**
 * <p>Java class for PhoneDFF complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PhoneDFF">
 *   &lt;complexContent>
...
@XmlType(name = "PhoneDFF", propOrder = {
    "phoneId",
    "flexContext",
    "flexContextDisplayValue",
    "flexNumOfSegments"
})
public class PhoneDFF {

    @XmlElement(name = "PhoneId")
    protected Long phoneId;
    @XmlElementRef(name = "__FLEX_Context", namespace = "http://xmlns.oracle.com/apps/hcm/people/core/flex/phoneDFF/", type = JAXBElement.class)
    protected JAXBElement<String> flexContext;
    @XmlElementRef(name = "__FLEX_Context_DisplayValue", namespace = "http://xmlns.oracle.com/apps/hcm/people/core/flex/phoneDFF/", type = JAXBElement.class)
    protected JAXBElement<String> flexContextDisplayValue;
    @XmlElementRef(name = "_FLEX_NumOfSegments", namespace = "http://xmlns.oracle.com/apps/hcm/people/core/flex/phoneDFF/", type = JAXBElement.class)
