 ...
 *       &lt;sequence>
 *         &lt;element name="AL" type="{http://xmlns.oracle.com/apps/hcm/employment/core/workerServiceV2/}Worker"/>
...
@XmlRootElement(name = "createWorkerAsync")
public class CreateWorkerAsync {
     ...
     *     
     */
    public void setAL(Worker value) {
        this.al = value;
    }
