...
/**
 * <p>Java class for AsgWorkMeasureDFF complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AsgWorkMeasureDFF">
 *   &lt;complexContent>
...
@XmlType(name = "AsgWorkMeasureDFF", propOrder = {
    "assignWorkMeasureId",
    "effectiveStartDate",
    "effectiveEndDate",
    "flexContext",
...
public class AsgWorkMeasureDFF {
    ...
    @XmlElementRef(name = "__FLEX_Context", namespace = "http://xmlns.oracle.com/apps/hcm/employment/core/flex/assignmentWorkMeasureDFF/", type = JAXBElement.class)
    protected JAXBElement<String> flexContext;
    @XmlElementRef(name = "__FLEX_Context_DisplayValue", namespace = "http://xmlns.oracle.com/apps/hcm/employment/core/flex/assignmentWorkMeasureDFF/", type = JAXBElement.class)
    protected JAXBElement<String> flexContextDisplayValue;
    @XmlElementRef(name = "_FLEX_NumOfSegments", namespace = "http://xmlns.oracle.com/apps/hcm/employment/core/flex/assignmentWorkMeasureDFF/", type = JAXBElement.class)
