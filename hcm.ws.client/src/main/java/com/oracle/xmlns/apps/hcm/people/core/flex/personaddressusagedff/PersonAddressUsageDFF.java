...
/**
 * <p>Java class for PersonAddressUsageDFF complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PersonAddressUsageDFF">
 *   &lt;complexContent>
...
@XmlType(name = "PersonAddressUsageDFF", propOrder = {
    "personAddrUsageId",
    "effectiveStartDate",
    "effectiveEndDate",
    "flexContext",
...
public class PersonAddressUsageDFF {
    ...
    @XmlElementRef(name = "__FLEX_Context", namespace = "http://xmlns.oracle.com/apps/hcm/people/core/flex/personAddressUsageDFF/", type = JAXBElement.class)
    protected JAXBElement<String> flexContext;
    @XmlElementRef(name = "__FLEX_Context_DisplayValue", namespace = "http://xmlns.oracle.com/apps/hcm/people/core/flex/personAddressUsageDFF/", type = JAXBElement.class)
    protected JAXBElement<String> flexContextDisplayValue;
    @XmlElementRef(name = "_FLEX_NumOfSegments", namespace = "http://xmlns.oracle.com/apps/hcm/people/core/flex/personAddressUsageDFF/", type = JAXBElement.class)
