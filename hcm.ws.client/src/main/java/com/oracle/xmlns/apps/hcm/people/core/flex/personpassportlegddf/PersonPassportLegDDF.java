...
/**
 * <p>Java class for PersonPassportLegDDF complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PersonPassportLegDDF">
 *   &lt;complexContent>
...
@XmlType(name = "PersonPassportLegDDF", propOrder = {
    "passportId",
    "flexContext",
...
@XmlSeeAlso({
    PersonPassportLegDDFIN.class,
    PersonPassportLegDDFKW.class,
    PersonPassportLegDDFAE.class
})
public class PersonPassportLegDDF {

    @XmlElement(name = "PassportId")
    protected Long passportId;
    @XmlElementRef(name = "__FLEX_Context", namespace = "http://xmlns.oracle.com/apps/hcm/people/core/flex/personPassportLegDDF/", type = JAXBElement.class)
    protected JAXBElement<String> flexContext;
    @XmlElementRef(name = "__FLEX_Context_DisplayValue", namespace = "http://xmlns.oracle.com/apps/hcm/people/core/flex/personPassportLegDDF/", type = JAXBElement.class)
    protected JAXBElement<String> flexContextDisplayValue;
    @XmlElementRef(name = "_FLEX_NumOfSegments", namespace = "http://xmlns.oracle.com/apps/hcm/people/core/flex/personPassportLegDDF/", type = JAXBElement.class)
