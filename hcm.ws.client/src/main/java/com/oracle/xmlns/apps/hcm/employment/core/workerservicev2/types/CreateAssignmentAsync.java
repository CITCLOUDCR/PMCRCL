 ...
 *       &lt;sequence>
 *         &lt;element name="AL" type="{http://xmlns.oracle.com/apps/hcm/employment/core/workerServiceV2/}Assignment"/>
...
@XmlRootElement(name = "createAssignmentAsync")
public class CreateAssignmentAsync {

    @XmlElement(name = "AL", required = true)
    protected Assignment al;
     ...
     *     
     */
    public void setAL(Assignment value) {
        this.al = value;
    }
