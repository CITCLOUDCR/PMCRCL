 ...
 *       &lt;sequence>
 *         &lt;element name="AL" type="{http://xmlns.oracle.com/apps/hcm/employment/core/workerServiceV2/}WorkTerms"/>
...
@XmlRootElement(name = "updateWorkTermsAsync")
public class UpdateWorkTermsAsync {

    @XmlElement(name = "AL", required = true)
    protected WorkTerms al;
     ...
     *     
     */
    public void setAL(WorkTerms value) {
        this.al = value;
    }
