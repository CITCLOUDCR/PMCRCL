...
/**
 * <p>Java class for WorkRelationshipDFF complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="WorkRelationshipDFF">
 *   &lt;complexContent>
...
@XmlType(name = "WorkRelationshipDFF", propOrder = {
    "periodOfServiceId",
    "flexContext",
    "flexContextDisplayValue",
    "flexNumOfSegments"
})
public class WorkRelationshipDFF {

    @XmlElement(name = "PeriodOfServiceId")
    protected Long periodOfServiceId;
    @XmlElementRef(name = "__FLEX_Context", namespace = "http://xmlns.oracle.com/apps/hcm/employment/core/flex/periodOfServiceDFF/", type = JAXBElement.class)
    protected JAXBElement<String> flexContext;
    @XmlElementRef(name = "__FLEX_Context_DisplayValue", namespace = "http://xmlns.oracle.com/apps/hcm/employment/core/flex/periodOfServiceDFF/", type = JAXBElement.class)
    protected JAXBElement<String> flexContextDisplayValue;
    @XmlElementRef(name = "_FLEX_NumOfSegments", namespace = "http://xmlns.oracle.com/apps/hcm/employment/core/flex/periodOfServiceDFF/", type = JAXBElement.class)
