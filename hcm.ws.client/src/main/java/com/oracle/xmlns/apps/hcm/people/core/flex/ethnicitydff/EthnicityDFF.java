...
/**
 * <p>Java class for EthnicityDFF complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="EthnicityDFF">
 *   &lt;complexContent>
...
@XmlType(name = "EthnicityDFF", propOrder = {
    "ethnicityId",
    "flexContext",
    "flexContextDisplayValue",
    "flexNumOfSegments"
})
public class EthnicityDFF {

    @XmlElement(name = "EthnicityId")
    protected Long ethnicityId;
    @XmlElementRef(name = "__FLEX_Context", namespace = "http://xmlns.oracle.com/apps/hcm/people/core/flex/ethnicityDFF/", type = JAXBElement.class)
    protected JAXBElement<String> flexContext;
    @XmlElementRef(name = "__FLEX_Context_DisplayValue", namespace = "http://xmlns.oracle.com/apps/hcm/people/core/flex/ethnicityDFF/", type = JAXBElement.class)
    protected JAXBElement<String> flexContextDisplayValue;
    @XmlElementRef(name = "_FLEX_NumOfSegments", namespace = "http://xmlns.oracle.com/apps/hcm/people/core/flex/ethnicityDFF/", type = JAXBElement.class)
