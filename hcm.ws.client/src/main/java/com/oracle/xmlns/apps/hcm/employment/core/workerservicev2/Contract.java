...
import com.oracle.xmlns.apps.hcm.employment.core.flex.contractddf.ContractLegDDF;
import com.oracle.xmlns.apps.hcm.employment.core.flex.contractdff.ContractDFF;
 ...
 *         &lt;element name="DurationUnits" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 ...
 *         &lt;element name="ExtensionPeriod" type="{http://www.w3.org/2001/XMLSchema}decimal" minOccurs="0"/>
 *         &lt;element name="ExtensionPeriodUnits" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 ...
 *         &lt;element name="ContractDFF" type="{http://xmlns.oracle.com/apps/hcm/employment/core/flex/contractDFF/}ContractDFF" minOccurs="0"/>
 *         &lt;element name="ContractLegDDF" type="{http://xmlns.oracle.com/apps/hcm/employment/core/flex/contractDDF/}ContractLegDDF" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Contract {
    ...
    @XmlElementRef(name = "ContractType", namespace = "http://xmlns.oracle.com/apps/hcm/employment/core/workerServiceV2/", type = JAXBElement.class)
    protected JAXBElement<String> contractType;
    @XmlElementRef(name = "Description", namespace = "http://xmlns.oracle.com/apps/hcm/employment/core/workerServiceV2/", type = JAXBElement.class)
    protected JAXBElement<String> description;
    @XmlElementRef(name = "Duration", namespace = "http://xmlns.oracle.com/apps/hcm/employment/core/workerServiceV2/", type = JAXBElement.class)
    protected JAXBElement<BigDecimal> duration;
    @XmlElementRef(name = "DurationUnits", namespace = "http://xmlns.oracle.com/apps/hcm/employment/core/workerServiceV2/", type = JAXBElement.class)
    protected JAXBElement<String> durationUnits;
    @XmlElement(name = "EffectiveStartDate")
    protected XMLGregorianCalendar effectiveStartDate;
    @XmlElement(name = "EffectiveEndDate")
    protected XMLGregorianCalendar effectiveEndDate;
    @XmlElementRef(name = "ExtensionPeriod", namespace = "http://xmlns.oracle.com/apps/hcm/employment/core/workerServiceV2/", type = JAXBElement.class)
    protected JAXBElement<BigDecimal> extensionPeriod;
    @XmlElementRef(name = "ExtensionPeriodUnits", namespace = "http://xmlns.oracle.com/apps/hcm/employment/core/workerServiceV2/", type = JAXBElement.class)
    protected JAXBElement<String> extensionPeriodUnits;
    @XmlElementRef(name = "ExtensionReason", namespace = "http://xmlns.oracle.com/apps/hcm/employment/core/workerServiceV2/", type = JAXBElement.class)
    protected JAXBElement<String> extensionReason;
    ...
    @XmlElement(name = "ContractDFF")
    protected ContractDFF contractDFF;
    @XmlElement(name = "ContractLegDDF")
    protected ContractLegDDF contractLegDDF;
    ...
    public void setContractType(JAXBElement<String> value) {
        this.contractType = ((JAXBElement<String> ) value);
    }
    ...
    public void setDuration(JAXBElement<BigDecimal> value) {
        this.duration = ((JAXBElement<BigDecimal> ) value);
    }
     ...
     *     
     */
    public JAXBElement<String> getDurationUnits() {
     ...
     *     
     */
    public void setDurationUnits(JAXBElement<String> value) {
        this.durationUnits = ((JAXBElement<String> ) value);
    }
     ...
     *     
     */
    public JAXBElement<BigDecimal> getExtensionPeriod() {
     ...
     *     
     */
    public void setExtensionPeriod(JAXBElement<BigDecimal> value) {
        this.extensionPeriod = ((JAXBElement<BigDecimal> ) value);
    }

    /**
     * Gets the value of the extensionPeriodUnits property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getExtensionPeriodUnits() {
        return extensionPeriodUnits;
    }

    /**
     * Sets the value of the extensionPeriodUnits property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setExtensionPeriodUnits(JAXBElement<String> value) {
        this.extensionPeriodUnits = ((JAXBElement<String> ) value);
    }
     ...
     *     
     */
    public JAXBElement<String> getExtensionReason() {
     ...
     *     
     */
    public void setExtensionReason(JAXBElement<String> value) {
        this.extensionReason = ((JAXBElement<String> ) value);
    }
    ...
    /**
     * Gets the value of the contractDFF property.
     * 
     * @return
     *     possible object is
     *     {@link ContractDFF }
     *     
     */
    public ContractDFF getContractDFF() {
        return contractDFF;
    }

    /**
     * Sets the value of the contractDFF property.
     * 
     * @param value
     *     allowed object is
     *     {@link ContractDFF }
     *     
     */
    public void setContractDFF(ContractDFF value) {
        this.contractDFF = value;
    }

    /**
     * Gets the value of the contractLegDDF property.
     * 
     * @return
     *     possible object is
     *     {@link ContractLegDDF }
     *     
     */
    public ContractLegDDF getContractLegDDF() {
        return contractLegDDF;
    }

    /**
     * Sets the value of the contractLegDDF property.
     * 
     * @param value
     *     allowed object is
     *     {@link ContractLegDDF }
     *     
     */
    public void setContractLegDDF(ContractLegDDF value) {
        this.contractLegDDF = value;
    }
